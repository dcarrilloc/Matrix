...
public class MatrixTest {
    ...
    public void add() {
        ...
        mat1 = new double[][]{ {2} };
        mat2 = new double[][]{ {3,4} };
        assertNull( Matrix.add(mat1, mat2));
        ...
        mat1 = new double[][]{ {3} };
        mat2 = new double[][]{ {4,5},{5,6} };
        assertNull( Matrix.add(mat1, mat2));

        mat1 = new double[][]{ {3,5},{5,6,8} };
        mat2 = new double[][]{ {4,5},{5,6} };
        assertArrayEquals(null, Matrix.add(mat1, mat2));
    ...
    public void trace() {
        ...
        mat1 = new double[][]{ { 6,3,7,8}, {12,84,3,21}, {99,33,6,24}, {10,15,12} };
        assertEquals(Double.NaN, Matrix.trace(mat1), 0.01);

        mat1 = new double[][]{ { 6,3,7,8}, {12,84,3,21}, {99,33,6,24} };
        assertEquals(Double.NaN, Matrix.trace(mat1), 0.01);

        mat1 = new double[][]{ { }, {12,84,3,21}, {99,33,6,24} };
        assertEquals(Double.NaN, Matrix.trace(mat1), 0.01);
    }
    ...
    public void transpose() {
        ...
        mat1 = new double[][]{ {5},{6,9} };
        assertArrayEquals(null
                , Matrix.transpose(mat1));

        mat1 = new double[][]{ {2,3},{4,5},{6,7} };
        assertArrayEquals(new double[][]{
                {2,4,6},{3,5,7}
        }        , Matrix.transpose(mat1));

        mat1 = new double[][]{ {2},{4},{7} };
        assertArrayEquals(new double[][]{
                {2,4,7}
        }        , Matrix.transpose(mat1));
    ...
    public void mult() {
        ...
        mat1 = new double[][]{ {1,2,3}, {4,5} };
        mat2 = new double[][]{ {1,3}, {2,4},{5,6} };
        assertArrayEquals(null, Matrix.mult(mat1, mat2));
    ...
    public void power() {
        ...
        mat = new double[][]{ {1,2,3},{4,5,6},{8,5,2} };
        assertArrayEquals(new double[][] {
                {1,0,0}, {0,1,0}, {0,0,1}
        }, Matrix.power(mat, 0));
        ...
        mat = new double[][] { };
        assertArrayEquals((null), Matrix.power(mat, 0));
    ...
    public void subMatrix() {
        ...
        assertArrayEquals(new double[][]{
                {1,2,3,5}, {4,5,6,8}, {7,8,9,3}
        }, Matrix.submatrix(mat, 0,0,3,2));

        mat = new double[][]{ {2,4,6},{3,5,7} };
        assertArrayEquals(new double[][]{
                {2,4},{3,5}
        }, Matrix.submatrix(mat, 0,0,1,1));
        ...
        mat = new double[][]{ {3} };
        assertArrayEquals(null, Matrix.submatrix(mat, 0,0,0,1));
    }
    ...
    public void testDeterminant() {
        ...
        mat = new double[][]{ {} };
        assertEquals(Double.NaN, Matrix.determinant(mat), 0.001);

        mat = new double[][]{  };
        assertEquals(Double.NaN, Matrix.determinant(mat), 0.001);

        mat = new double[][]{ {1,2},{5,9,8} };
        assertEquals(Double.NaN, Matrix.determinant(mat), 0.001);

        mat = new double[][]{ {},{5,9,8} };
        assertEquals(Double.NaN, Matrix.determinant(mat), 0.001);
    ...
    public void testInv() {
        ...
        compareArraysDouble(new double[][]{{1,0,0}, {0,1,0}, {0,0,1}},
                Matrix.invert(mat), 0.01);

        mat = new double [][]{ {1,3,3}, {4,5,6}, {7,8,9} };
        compareArraysDouble(new double[][]{ {-0.5,-0.5,0.5}, {1,-2,1}, {-0.5,2.1666,-1.1666} },
                Matrix.invert(mat), 0.01);
    ...
    public void div() {
        ...
        mat1 = new double[][]{ {5,9},{1,2} };
        mat2 = new double[][]{ {9,9},{2,0} };
        compareArraysDouble(new double[][]{
                {1,-2}, {0.222,-0.5}
        }, Matrix.div(mat1, mat2), 0.01);
        ...
        mat1 = new double[][]{  };
        mat2 = new double[][]{ {9,9},{2,0} };
        assertNull(Matrix.div(mat1, mat2));
        ...
        mat1 = new double[][]{ {0,0,0},{0,0,0},{0,0,0} };
        mat2 = new double[][]{ {0,0,0},{0,0,0},{0,0,0} };
        assertNull(Matrix.div(mat1, mat2));
    }
    ...
    public void isOrtho() {
        ...
        mat = new double[][]{ {3,2,5},{5,6,9,8,5,2} };
        assertFalse(Matrix.isOrtho(mat));
    }
